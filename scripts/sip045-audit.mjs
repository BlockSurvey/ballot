...
// ─── Poll Configuration ───────────────────────────────────────────────────────
const POLL_TITLE = 'SIP-045 (PoX-5 Bitcoin Staking & Emission Schedule Alignment)'

const CONTRACT_ADDRESS = 'SP2NK4JSD4FC36P88E217XMKRCK74F1FH69MEASFA'
const CONTRACT_NAME = 'ballot-sip-045-pox-5-bi-Whw4V'
...
// Options
const YES_OPTION_ID = '8addb337-9611-4b33-bf00-d3dcef751de3'
const NO_OPTION_ID = 'a364ae45-fa12-4dd2-ad3f-59063b13ad23'

// STX Dust Voting Addresses
const STX_YES_ADDR = 'SP000000000F5JQ6BAK9582TC1M6MVSVBX8'
const STX_NO_ADDR = 'SP00000000001Q6YBAK9582TC1M6P8BXRYP'

// BTC Dust Voting Addresses
const BTC_YES_ADDR = '11111111114Pz8NZSx6YHoTaWcPVrBe'
const BTC_NO_ADDR = '11111111111hbmNftsTSgeVC4YK5SY'
...
const main = async () => {
  ...
  const prefix = `sip045-audit-${timestamp}`
