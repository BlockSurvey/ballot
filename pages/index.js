...
export default function Home() {
  ...
  const description = "Empower your DAO, NFT, or DeFi community with transparent, token-gated voting on the Bitcoin-secured Stacks blockchain.";
  const keywords = "decentralized polls, polls on chain, decentralized voting system, voting, ballot box, blockchain voting, blockchain poll, voting system, poll system, DAO governance, token gated voting";
            ...
            <Navbar expand="lg" className={styles.navbar_modern}>
              ...
              <Navbar.Collapse id="navbarScroll">
                ...
                <Nav className={styles.navbar_nav}>
                  ...
                  <Button className={`btn_big ${styles.nav_cta}`} variant="dark" onClick={() => { authenticate() }}>Start voting</Button>
                </Nav>
              </Navbar.Collapse>
            </Navbar>
              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  <div className={styles.hero_content}>
                    ...
                    <h1 className={styles.hero_title}>Govern together with trustless, token‑gated voting.</h1>
                    <p className={styles.hero_subtitle}>
                      Ballot.gg powers community decisions for DAOs, NFT communities, and DeFi projects—
                      transparent, verifiable, and on‑chain. Connect with Hiro Wallet, Xverse, or Asigna.
                    </p>
              ...
              <div className="row g-4">
                <div className="col-md-6 col-lg-3">
                  <div className={styles.feature_card}>
                    ...
                    <h3 className={styles.feature_title}>Token‑Gated Voting</h3>
                    <p className={styles.feature_desc}>Gate polls by FT, NFT, STX, or .btc namespaces to ensure only your community decides.</p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-3">
                  <div className={styles.feature_card}>
                    ...
                    <p className={styles.feature_desc}>FPTP, Block Voting, Quadratic, and Weighted voting systems out of the box.</p>
                  </div>
                </div>
                <div className="col-md-6 col-lg-3">
                  <div className={styles.feature_card}>
                  ...
                  <div style={{ marginBottom: "20px" }} className={styles.how_it_works_step_box}>
                    <div>
                      ...
                      <h3 className={styles.how_it_works_step_title}>
                        Connect your Stacks wallet (Hiro Wallet, Xverse, or Asigna) to get started.
                      </h3>
                    </div>
