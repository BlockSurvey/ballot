          ...
          <div className="row g-4">
            ...
            <div className="col-6 col-md-2">
              <div className={styles.footer_col}>
                ...
                <a className={styles.footer_link} href="#faq">FAQ</a>
              </div>
            </div>
            <div className="col-6 col-md-2">
              <div className={styles.footer_col}>
              ...
              <div className={styles.footer_col} style={{ marginTop: '24px' }}>
                <div className={styles.footer_title}>Support</div>
                <a className={styles.footer_link} href="mailto:wilson@blocksurvey.org?subject=Ballot.gg%20Support%20Request&body=Hi%20Ballot%20Team%2C%0A%0AI%20need%20help%20with%3A%0A%0A%5BDescribe%20your%20issue%20or%20question%20here%5D%0A%0AWallet%20Address%3A%20%0ABrowser%3A%20%0A%0AThank%20you!">Contact us</a>
              </div>
            </div>
            <div className="col-md-4">
              <div className={styles.footer_col}>
